...
├── src 
    ├──analysis
        ├──  vibration_analysis.py          # Main vibration analysis
        ├── Precise_vibration_analysis.py  # Enhanced version with better features
        ├── spectogram.py                   # Frequency domain analysis
        ├── spectrum.py                     # Multi-file PSD comparison
        ├── Traffic_analysis.py             # Comprehensive traffic analysis
        ├── traffic.py      # Moving average traffic analysis
        ├── frequency_reduction.py          # Data reduction for storage
├── filtering_script_v5.py          # Threshold-based filtering
├── thresholds.py                   # Automatic threshold computation
├── less_traffice_event_finder.py  # Isolated event detection
├── graph_for_etfa.py              # Publication graphs
├── eda.ipynb                       # Exploratory data analysis notebook
└── shared/
    └── sensors.csv                 # Sensor metadata and positions
```
